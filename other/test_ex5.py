from other.image_processing import *
...
def test_quantize():
    assert quantize([[0, 50, 100], [150, 200, 250]], 8) == [[0, 32, 96],
                                                            [128, 191, 223]]
...
def test_image_processing():
    image = load_image("examples/ziggy.jpg")
    cartoon_ziggy = load_image("examples/ziggy_cartoon.jpg")
    show_image(cartoonify(image, 5, 15, 17, 8))
"""